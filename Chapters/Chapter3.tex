...
A Recurrent Neural Network (RNN) is a type of ANN which can handle sequences of data by processing them element-wise and storing in the internal memory (hidden state). A part of an RNN is presented on fig. \ref{fig:rnn-unrolled}
