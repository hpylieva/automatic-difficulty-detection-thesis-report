...
\subsection{Reproduction of previous results}
...
\subsection{Experiments with cross-validation settings}
\subsubsection{User-in vocabulary-out cross-validation}
...
\subsubsection{User-out vocabulary-in cross-validation}
...
\subsubsection{User-out vocabulary-out cross-validation}
...
\subsection{Generalizability study}
