...
% for perfect conditions in equations
...
\textbf{FrnnMute} & \textbf{F}rench \textbf{r}ecurrent \textbf{n}eural \textbf{n}network \textbf{M}edical \textbf{U}nderstability \textbf{T}ext \textbf{E}mbeddings\\
